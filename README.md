...
1. Step 1 is to find subtypes with `mfmr`
2. Step 2 is to validate subtypes by testing for subtype-specific covariate effects with `droptest` or `interxn_test`
